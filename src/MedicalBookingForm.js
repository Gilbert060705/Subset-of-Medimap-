...
const MedicalBookingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.date < today) {
      alert("The date must be later or equal to today's date.");
      return;
    }
    ...
    try {
      ...
      const templateParams = {
        ...
        documentlink: documentUrl || 'No document uploaded'
      };
        ...
        <form className="appointment-form" onSubmit={handleSubmit}>
          <div className="bookingPage-form-grid">
            ...
            <div className="bookingPage-details-section">
              ...
              <div>
                <label className="bookingPage-input-label">
                  Document supported* (if any):
                </label>
                <input
                  type="file"
                  name="document"
            ...
            <div className="bookingPage-booking-section">
              <h3 className="bookingPage-section-title white-text">
                Book an appointment now.
              </h3>
              <div className="bookingPage-mb-4">
                <label className="bookingPage-input-label white-text">
                  Type of Service
                </label>
              ...
              <button type="submit" className="bookingPage-submit-button">
                Book now
              </button>
            </div>
          </div>
